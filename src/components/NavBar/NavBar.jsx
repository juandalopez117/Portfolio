...
const NavBar = () => {
  ...
  return (
                ...
                <AppBar sx={{background: '#000000', boxShadow:'none', position:'sticky' }}>
                <Toolbar>
                <TerminalIcon/>
                {
                    isMatch ? (
                 ...
                 : (
                    <>
                        ...
                        <Tabs sx={{marginLeft: 'auto', marginRight: '5%'}} 
                        value={value}
                        ...
                        aria-label="secondary tabs example">
                            {
                                !StateButton ? (pages.map((page, index) => (<Tab key={index} label={page} href={LinksESP[index]} />) ))
                                : 
                                (pagesENG.map((page, index) => (<Tab key={index} label={page} href={LinksENG[index]}/>) ))
                            }
                        </Tabs>
                    </>
                )
